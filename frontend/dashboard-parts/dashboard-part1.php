<div class="container dashboard_container mt-2">
	...
	<?php 
        ...
        $globalEnquiryCount = count($wpdb->get_results(
                    "SELECT * FROM ". $tbl_globalEnquiry ." WHERE physio_id IS NULL AND TIMEDIFF('". $currentDateTime ."', date_created) < '23:59:59'"
                  ));
	 ?>
		...
		<div class="row justify-content-center">
			<div class="card col-md-5 col-sm-6 mb-2 px-0 mx-1">
				...
				<div class="card-body">
					<h3 class="card-text">
						...
						<?= ( $physio_is_promoted == 1) ? '<p>Featured User</p>' : '<p class="">Referrer User</p>'; ?>
					</h3>
			...
			<div class="card inquiry-card col-md-5 col-sm-6 mb-2 px-0 mx-1">
				...
				<div class="card-body">
					...
					<h3 class="card-text">Enquiry in Global List</h3>
				</div>
			</div>
			<?php
		}
