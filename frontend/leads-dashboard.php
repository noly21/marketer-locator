	...
	function leads_dashboard() {
		...
		if(is_user_logged_in()){
			...
			if($user_roles == 'referrer_leads'){
				redirect_me_to( home_url() . '/referrer-dashboard' );
			}
		...
		$inputGendermain = (!empty($physioId)) ? get_post_meta($physioId, 'store_locator_gender_main', true) : '' ;
		...
		$service_type_output_log = get_post_meta( $physioId, "store_locator_service_type", true ); 
		
		$store_locator_category =  get_term_by('id', $service_type_output_log, 'store_locator_category');
			...
			<div class="row">
				<div class="col-md-2 px-0">
					<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
						...
						<a class="nav-link" id="global-physio-enquiry-tab" data-toggle="pill" href="#global-physio-enquiry" role="tab" aria-controls="global-physio-enquiry" aria-selected="false"><i class="far fa-list-alt"></i> <p>Your Global / Referrer List</p></a>
						...
						<a class="nav-link" id="local-physio-enquiry-tab-all" data-toggle="pill" href="#local-physio-enquiry-all" role="tab" aria-controls="local-physio-enquiry-all" aria-selected="false"><i class="far fa-check-circle"></i> <p>All Purchased Leads</p></a>
						<!-- <a class="nav-link" id="local-referrer-leads-tab" data-toggle="pill" href="#local-referrer-leads" role="tab" aria-controls="local-referrer-leads" aria-selected="false"><i class="far far fa-star"></i> <p>Referrer leads</p></a>-->
				...
				<div class="col-md-10">
					<div class="tab-content" id="v-pills-tabContent">
						...
						<div class="tab-pane fade" id="local-physio-enquiry-all" role="tabpanel" aria-labelledby="local-physio-enquiry-tab-all">
							<?php include( plugin_dir_path( __FILE__ ) . 'dashboard-parts/all-purchased.php'); ?>
						</div>
						<div class="tab-pane fade" id="local-referrer-leads" role="tabpanel" aria-labelledby="local-referrer-leads-tab">
							<?php include( plugin_dir_path( __FILE__ ) . 'dashboard-parts/referrer-leads-part.php'); ?>
						</div>
					...
					<div class="modal fade" id="upgradeAccountInfo" tabindex="-1" role="dialog" aria-labelledby="upgradeAccountInfo" aria-hidden="true">
					  <div class="modal-dialog modal-dialog-centered" role="document">
					    <div class="modal-content">
					      ...
					      <div class="modal-body">
					      	<p>Upgrade your account now and become one of <span class="font-weight-bold">the Three Featured Physiotherapist</span> in your PostCode!</p><br>
					      	<p>You will enjoy <span class="font-weight-bold">Priority Listings</span> - You will appear first in all Listings for your categories in your postcode!</p><br>
					      	<h2>£30.00 for three months</h2> 
							<p>Just £10.00 per month
					      	<div class="mt-3"></div>
