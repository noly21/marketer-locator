<?php 
	...
	add_shortcode('register_referrer_page_v2', 'register_referrer_page_func');
	function register_referrer_page_func(){
		global $wpdb;
		?>
		<?php 
							...
							<div class="form-row">
								...
								<div class="form-group col-md-6">
									<?php 
									 ...
									 ?>
									<label for="inputCategory">Speciality<span class="text-danger required">*</span></label>
