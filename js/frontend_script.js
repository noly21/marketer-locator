...
jQuery(document).ready(function (jQuery) {
    ...
    jQuery('#store_locatore_search_btn').on('click', function () {
        ...
        //added
        var addresscategory = document.getElementById("wpsl_store_locator_category").value;
        var addressgender = document.getElementById("wpsl_store_locator_gender").value;
		...
		console.log(jQuery('#store_locator_search_form').serialize());
